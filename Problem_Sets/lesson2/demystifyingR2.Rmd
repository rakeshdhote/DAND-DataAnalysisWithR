...
```{r}
answers <- mtcars[mtcars$mpg >=30 | mtcars$hp < 60,]
answers
```


## Once you have the answer, go the [Udacity website](https://www.udacity.com/course/viewer#!/c-ud651-nd/l-729069797/e-804129319/m-811719066) to continue with Lesson 2.
